...
import com.example.wind.sapi_adv.Models.Author;
import com.example.wind.sapi_adv.Models.Post;
        ...
        protected Void doInBackground(Void... params) {
            ...
            fullSizeRef.putBytes(bytes).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    final Uri fullSizeUrl = taskSnapshot.getUploadSessionUri();
                    ...
                    thumbnailRef.putBytes(thumbnailStream.toByteArray())
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            final Uri thumbnailUrl = taskSnapshot.getUploadSessionUri();
